...
import formStyles from "./Portfolio.module.css";
...
export default function Portfolio() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const hasSubmitted = localStorage.getItem('visitorSubmitted');
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (name && email) {
      try {
        ...
        if (response.ok) {
          if (typeof window !== 'undefined') {
            localStorage.setItem('visitorSubmitted', 'true');
          }
          setShowForm(false);
  ...
  useEffect(() => {
    ...
    if (textElement && !showForm) {
      typed = new Typed(`.${styles.text}`, {
    ...
    <div className={styles.body}>
      {showForm ? (
        <div className={formStyles.formWrapper}>
          <h2 className={formStyles.title}>Welcome to Abhishek's Portfolio</h2>
          <p className={formStyles.subtitle}>Please share your details to continue</p>
              ...
              <div className={styles.container}>
                ...
                <div className={styles.prjList}>
                  ...
                  <div>
                    ...
                    <h2>UI / UX Design</h2>
                    <p>
                      Specialized in creating clean, artful design that are
